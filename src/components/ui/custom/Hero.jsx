  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10">
        {/* Main Hero Section */}
        <div className="relative flex flex-col items-center px-4 md:px-56 gap-9 pt-20 pb-16 backdrop-blur-sm">
          <h1 className="font-extrabold text-4xl md:text-[60px] text-center mt-16 leading-tight">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-600 block mb-2 animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-slate-600 text-center max-w-2xl animate-fade-in-delay">
            Your personal trip planner and travel curator, create custom
            itineraries tailored to your interests and budget.
          </p>

          <Link to="/create-trip">
            <Button className="transform transition-all duration-300 hover:scale-105 hover:shadow-xl bg-gradient-to-r from-violet-600 to-indigo-600 text-white px-8 py-3 rounded-full">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="flex justify-center gap-12 my-20">
            ...
            <div className="text-center p-6 bg-gradient-to-br from-white/90 to-white/50 rounded-xl shadow-lg hover:shadow-xl transition-all">
              <div className="text-4xl font-bold bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">10k+</div>
              <div className="text-slate-700 font-medium">Happy Travelers</div>
            </div>
            <div className="text-center p-6 bg-gradient-to-br from-white/90 to-white/50 rounded-xl shadow-lg hover:shadow-xl transition-all">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-12 bg-gradient-to-r from-violet-800 to-indigo-700 bg-clip-text text-transparent">
              How It Works
            </h2>
            <div className="flex flex-col md:flex-row justify-center gap-8 relative">
              ...
              <div className="flex-1 relative z-10 bg-gradient-to-br from-white/90 to-white/50 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border border-violet-100">
                <div className="text-xl font-bold mb-3 text-violet-800">1. Share Preferences</div>
                <p className="text-slate-600">Tell us about your travel style and interests</p>
              </div>
              <div className="flex-1 relative z-10 bg-gradient-to-br from-white/90 to-white/50 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border border-violet-100">
